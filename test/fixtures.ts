...
import forceswapV2ERC20 from '@forceswap/v2-core/build/ERC20.json'
...
export async function stakingRewardsFixture([wallet]: Wallet[]): Promise<StakingRewardsFixture> {
  ...
  const stakingToken = await deployContract(wallet, forceswapV2ERC20, [expandTo18Decimals(1000000)])
